    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <div class="fadeIn first">
          <v-img src="/NC.png" style="height: 210px"></v-img>
  ...
  methods: {
    async login() {
      ...
      try {
        ...
        this.$auth.$storage.setUniversal("token", response.data[0].Token);
        this.$auth.$storage.setUniversal("userId", response.data[0].userId);
      ...
      //         if (data.request.response.includes('Error')){
      //           this.error = true;
      //           this.error_msg = data.request.response;
      //         }else{
      //           this.$router.push('dashboard');
      //         }
      //     }else{
